                    ...
                    <table width="100%" class="base-normal-table">
                        ...
                        <#if tableNum == 0>
                            <tr>
                                <td colspan="9" align="center">
                                    <div style="text-align: center" class="base-header-mid<#if tableNum ==0> second-title</#if>">详细个人评审</div>
                                </td>
                            </tr>
                        </#if>
                        ...
                        <#list gradeDto.gradeItemDTOs as item>
                            <tr class="base-border">
                                ...
                                <td style="line-height: 1.6rem;text-align: center">${item.gradeItemName}</td>
