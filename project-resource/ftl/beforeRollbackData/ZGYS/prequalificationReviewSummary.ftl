            ...
            <table height="100%" class="base-normal-table base-write">
                ...
                <tr>
                    <td colspan="5" align="center">
                        <div class="base-header-mid second-title base-bold">资格预审评审汇总表</div>
                    </td>
                </tr>
                <tr>
                    <td colspan="5" align="left">
                        <div style="width: 79%; float: left; text-align: left">标段名称：${bidSection.bidSectionName}</div>
                        <div style="width: 20%; float: left; text-align: right">${date[0]}年${date[1]}月${date[2]}日</div>
                    </td>
                </tr>
...
<#--                        <div style="width: 20%; float: left; text-align: left">评审专家：<#if expertUsers>${expertUsers[0].expertName}</#if></div>-->
<#--                    </td>-->
<#--                </tr>-->
<#--                </tfoot>-->
            </table>
