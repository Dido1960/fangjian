        ...
        <#list 0..(endNum-1) as tableNum>
            ...
            <div class="panel pagination">
                <table height="100%" class="base-normal-table base-write">
                    <thead>
                    <tr>
                        <td colspan="4" align="left">评标报告附件四</td>
                    </tr>
                    <tr>
                        <td colspan="4" align="center">
                            <div class="base-header-mid first-title base-bold">评标委员会成员个人评审意见表</div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="4" style="padding-top: 20px;">评审专家 ${expert.expertName} 签字：</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
