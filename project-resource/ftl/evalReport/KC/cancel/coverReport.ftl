            ...
            <table class="base-normal-table">
                ...
                <tr>
                    <td style="height: 180px; padding-top: 100px">
                        <div class="well-box base-header-mid" style="text-align: center;line-height:50px"><span style="text-decoration: underline;;line-height: 2rem;">${bidSection.bidSectionName} </span>工程</div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="well-box base-header first-title" style="text-align: center;">勘察评标报告</div>
                    </td>
                </tr>
<#--                <tr>-->
