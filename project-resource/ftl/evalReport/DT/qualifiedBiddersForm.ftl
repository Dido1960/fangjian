                        ...
                        <tr>
                            <td colspan="4" align="center">
                                <div style="text-align: center"
                                     class="base-header-mid<#if tableNum ==0> first-title</#if>">合格投标人名单
                                </div>
                            </td>
                        </tr>
                    </#if>
                    ...
                    <tr>
                        <td colspan="4" align="left">
                            <div style="width: 79%; float: left; text-align: left">
                                标段编号：${bidSection.bidSectionCode}</div>
                            <div style="width: 20%; float: left; text-align: right">日期：${date[0]}年${date[1]}月${date[2]}
                                日
                            </div>
                        </td>
                    </tr>
                    ...
                    <#list i..j as num>
                        <#if qualifiedBidders[num]>
                            <tr class="base-border">
                                ...
                                <td align="center"><#if !qualifiedBidders[num].bidderOpenInfo.bidPriceType?? || qualifiedBidders[num].bidderOpenInfo.bidPriceType == "总价">
