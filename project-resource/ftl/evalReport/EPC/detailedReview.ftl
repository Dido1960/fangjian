        ...
        <div class="show">
            <div class="panel pagination">
                <table width="100%" class="base-normal-table">
                    ...
                    <tr>
                        <td colspan="${colspan + 2 }" align="center">
                            <div style="text-align: center"
                                 class="base-header-mid<#if bidder_index ==0> first-title</#if>">详细评审明细表</div>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr class="base-border">
                        <td class="base-normal-thead-nopadding" width="12%" align="center" rowspan="2">评标专家</td>
                        <#list gradeDtos as gradeDto>
                            <td class="base-normal-thead-nopadding" align="center" colspan="${gradeDto.gradeItemDTOs?size}">${gradeDto.gradeName}(${gradeDto.score}分)</td>
                        </#list>
                        <td class="base-normal-thead-nopadding" width="7%" align="center" rowspan="2">得分合计</td>
                    </tr>
                    <tr class="base-border">
                        <#list gradeDtos as gradeDto>
                            <#list gradeDto.gradeItemDTOs as gradeItemDTO>
                                <td class="base-normal-thead-nopadding" width="3%" style="text-align: center">${gradeItemDTO_index + 1} <br>${gradeItemDTO.score!}分</td>
                            </#list>
                        </#list>
                    </tr>
                    </thead>
                    ...
                    <#list expertUsers as expert>
                        <tr class="base-border">
                            <td class="base-normal-tbody-nopadding" align="center">${expert.expertName}</td>
                            ...
                            <#list gradeDtos as gradeDto>
                                <#list gradeDto.gradeItemDTOs as item>
                                    ...
                                    <#--打印每个专家的评分-->
                                        <#if expertDto??>
                                            <td class="base-normal-tbody-nopadding" align="center">${expertDto.expertReviewDetail}</td>
                            ...
                            <td class="base-normal-tbody-nopadding" align="center">${expertSumScore}</td>
                        </tr>
                    </#list>
                    </tbody>
                    <tfoot>
                    <tr>
                        <td colspan="${colspan + 2}" style="padding-top: 20px;">
                            <div style="float: left; text-align: left">评标委员会成员签字：</div>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="${colspan + 2}" style="padding-top: 20px;">
                            <div style="float: left; text-align: left">监标人签字：</div>
                        </td>
                    </tr>
                    </tfoot>
                </table>
