        ...
        <#--初步评审表-->
            <div class="panel pagination">
                <table width="100%" class="base-normal-table">
                    ...
                    <tr>
                        <td colspan="6" align="left">标段名称：${bidSection.bidSectionName}</td>
                    </tr>
                    <tr>
                        <td colspan="6" align="left">
                    ...
                    <#list i..j as num>
                        <#if evalResults[num]??>
                            <tr class="base-border">
                                ...
                                <td align="center" width="10%">
                                    <#if evalResults[num].bidPrice??>
                                        ${((evalResults[num].bidPrice)?number)?string(",###.00")}
                                    </#if>
                                </td>
                                <td align="center" width="10%">
                                    ${evalResults[num].businessScore}
                                </td>
                                <td align="center" width="10%">
                                    ${evalResults[num].detailedScore}
                                </td>
                                <td align="center" width="10%">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            <td colspan="6" style="padding-top: 20px;">
                                <div style="float: left">监标人签字：</div>
                            </td>
                        </tr>
                    </tfoot>
                </table>
