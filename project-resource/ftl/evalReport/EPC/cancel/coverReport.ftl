                        ...
                        <ul class="base-ul" style="font-size: 16px">
                            ...
                            <li style="text-indent: 2em;">
                                ...
                                <#if qualificationStepEnd>
                                    经过
                                    <#--默认获取通过初步评审的投标人-->
                                    <#assign  bidders = passFirstStepBidders/>
                                    <#if firstStepEnd>
                                        初步评审，
                                    <#else >
                                        资格审查，
                                        <#assign  bidders = passQualifyReviewBidders/>
                                    </#if>
                                    <u>
                                        <#list bidders as bidder>
                                            <#if bidder_index < bidders?size - 1>
                                                ${bidder.bidderName}、
                                            <#else >
                                                ${bidder.bidderName}
                                            </#if>
                                ...
                                <#assign  nopassnum = 0/>
                                <#if !qualificationStepEnd >
                                    <#assign  nopassnum = passBidOpenBidders?size - passQualifyReviewBidders?size/>
                                <#else >
                                    <#assign  nopassnum = passBidOpenBidders?size - passFirstStepBidders?size/>
                                </#if>
                                <#if nopassnum gt 0>
                                    ，共 <span style="text-underline: black">&emsp;&emsp;${nopassnum}&emsp;&emsp;</span> 家未通过评审。
                                <#else >
                                    。
                                </#if>
                            </li>
