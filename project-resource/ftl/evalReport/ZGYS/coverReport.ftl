            ...
            <table class="base-normal-table">
                ...
                <tr>
                    <td style="height: 180px; padding-top: 100px">
                        <div class="well-box base-header-mid" style="text-align: center;line-height:50px"><span style="text-decoration: underline;;line-height: 2rem;"><span style="text-decoration: underline;;line-height: 2rem;">${bidSection.bidSectionName} </span>工程</div>
                    </td>
                </tr>
                <tr>
                    <td>
                            ...
                            <li style="text-indent: 2em;">
                                <table height="100%" class="base-normal-table base-write">
                                    ...
                                    <tr class="base-border base-bold" style="text-align: center">
                                        ...
                                        <td align="center" width="60%">资格预审申请人</td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <#if passEvalBidder>
                                        <#list passEvalBidder as bidder>
