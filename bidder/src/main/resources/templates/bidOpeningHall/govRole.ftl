    ...
    <style>
        * {
        ...
        .cont .close {
            ...
            width: 48px;
            height: 48px;
            background: url(${ctx}/img/button_close.png) no-repeat center center;
...
<body>
    <div class="cont">
        ...
        <ul class="three">
            <li onclick="goToPage('${govAgency}')">
                <img src="${ctx}/img/agent_small.png" alt="">
                <span>招标代理机构</span>
            </li>
            <li onclick="goToPage('${govSupplier}')">
                <img src="${ctx}/img/bidder_small.png" alt="">
                <span>供应商</span>
            </li>
            <li onclick="goToPage('${govFileMake}')">
                <img src="${ctx}/img/documentMake.png" alt="">
                <span>招标文件制作</span>
            </li>
        </ul>
    </div>
