<link rel="stylesheet" href="${ctx}/css/pass.css">
...
<div class="right-center">
    ...
    <div class="pass">认证通过</div>
    <p>签到时间：${bidderOpenInfo.signinTime}</p>
</div>
<div class="revoke red-b" onclick="cancelIdentity()">撤销签到</div>
...
<script>
    ...
    function cancelIdentity() {
        $.ajax({
            url: "${ctx}/identityAuth/cancelIdentity",
            type: "POST",
            cache: false,
            async: false,
            data: {
