...
<form class="layui-form" id="dissentForm">
    ...
    <div class="uploadFileBtn" onclick="upLoadFile()">上传文件</div><br> <br>

    <label for="">异议内容</label>
    <textarea name="message" id="" lay-verify="message"></textarea>
    ...
    <div style="display: none">
        ...
        <input type="hidden" name="sendName" value="${bidder.bidderName}">
    </div>
</form>
