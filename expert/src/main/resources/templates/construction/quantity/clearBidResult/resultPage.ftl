<link rel="stylesheet" href="${ctx}/css/quantity/result.css">
...
<div class="right">
    ...
    <iframe name="clearResultForm" style="width: 100%; height: calc(100vh - 334px); min-height: 500px" frameborder="0" scrolling="auto"></iframe>
</div>
<script>
    $(function () {
