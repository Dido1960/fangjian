...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/css/epcDetailedResult.css">
</head>
<body>
...
<script>
    ...
    function loadPersonDetailed() {
        $("#grade_base").load("${ctx}/expert/epcBidEval/epcDetailedPersonContent",
            function () {
                // 添加跨域参数
                $.ajaxSetup({
                    type: "POST",
    ...
    function loadGroupDetailed() {
        $("#grade_base").load("${ctx}/expert/epcBidEval/epcDetailedGroupContent",
            function () {
                // 添加跨域参数
                $.ajaxSetup({
                    type: "POST",
