...
<section>
    <div class="process">
        ...
        <ul>
            <li id="rankingSummary" onclick="goToUrl('${ctx}/expert/otherBidEval/successCandidatePage',this,null)">
...
<script>
    ...
    function showProcessNow(obj) {
        $(obj).siblings("li").removeClass("number");
        $(obj).addClass("number");
    }
    ...
    function checkSelect(obj) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 2) {
                    goPdfToUrl('${ctx}/expert/otherBidEval/evaluationReportPage',obj,"正在生成评标报告...");
                }else {
                    goToUrl('${ctx}/expert/otherBidEval/evaluationReportPage',obj,null);
                }
            },
            error:function (e) {
                console.error(e);
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.code === "2") {
                    ...
                    goToUrl('${ctx}/expert/otherBidEval/evaluationEndPage',obj,null)
                }
            },
            error:function (e) {
                console.error(e);
