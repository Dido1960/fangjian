...
<div class="document-right" style="background: #cfdae5">
    <table cellpadding=0 cellspacing=0 class="layui-table" style="width: calc(100% - 14px);">
        <thead>
        <tr>
        ...
        <table cellpadding=0 cellspacing=0 class="layui-table">
            ...
            <#list grade.gradeItems as item>
                <tr>
                    ...
                    <#list expertUsers as expert>
                        <td id="result_${item.id}_${expert.id}" onclick="showReasonTips(this)" class="groupTips"></td>
                    </#list>
