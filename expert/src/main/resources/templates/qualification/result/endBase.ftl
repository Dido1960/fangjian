...
<section>
    <div class="process">
        ...
        <ul>
            <li id="rankingSummary" onclick="goToUrl('${ctx}/expert/preBidEval/passListSortPage',this,null)">
    ...
    function checkSelect(obj) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 2) {
                    goPdfToUrl('${ctx}/expert/preBidEval/evaluationReportPage',obj,"正在生成评标报告...");
                }else {
                    goToUrl('${ctx}/expert/preBidEval/evaluationReportPage',obj,null);
                }
            },
            error:function (e) {
                console.error(e);
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.code === "2") {
                    ...
                    goToUrl('${ctx}/expert/preBidEval/evaluationEndPage',obj,null)
                }
            },
            error:function (e) {
                console.error(e);
