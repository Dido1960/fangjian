...
<#--        <li fdfsMark="/bidderFile/{bidDocId}/resources/TempConvert/BidContent.pdf">投标文件</li>-->
        <li id="tenderFile" fdfsMark="/bidderFile/{bidDocId}/resources/TempConvert/QUtemp.pdf">
            资格证明
        </li>
        <li id="tenderFile" fdfsMark="/bidderFile/{bidDocId}/resources/TempConvert/BStemp.pdf">
            商务标
        </li>
        <li id="tenderFile" fdfsMark="/bidderFile/{bidDocId}/resources/TempConvert/TEtemp.pdf">
            技术标
        </li>
    </ol>
            ...
            <ul class="list" id="leftUl" style="display: none">
                <#list bidders as bidder>
                    <li data-id="${bidder.id}" onclick="selectBidderId(this)"
                        title="${bidder.bidderName}">${bidder_index+1}.${bidder.bidderName}</li>
                </#list>
            </ul>
        </div>
    </div>
