 ...
 */
@Configuration
@EnableRedisHttpSession(maxInactiveIntervalInSeconds = 3600,redisNamespace = "bid_con_worker_session")
public class RedisSessionConfig {
    ...
    public DefaultCookieSerializer defaultCookieSerializer() {
        ...
        cookieSerializer.setCookieName("NORMAL_BID_CON_WORKER_COOKIE");
