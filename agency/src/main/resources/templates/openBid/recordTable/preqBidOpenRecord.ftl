    ...
    <form action="">
        <ul class="shang">
            ...
            <li>
                ...
                <input id="test1" type="text" class="layui-bg-gray" value="${(tenderDoc.bidOpenTime)!""}" readonly>
            </li>
            <li style="width: 100%">
                <label for="bidOpenPlace">开标地点</label>
                <input type="text" id="bidOpenPlace" value="${(tenderDoc.bidOpenPlace)!""}" onblur="validData()"
                       style="width: 84%">
            </li>
        </ul>
