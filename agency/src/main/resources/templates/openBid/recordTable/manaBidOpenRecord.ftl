    ...
    <form action="">
        <ul class="shang">
            ...
            <li style="width: 100%">
                ...
                <input type="text" id="bidOpenPlace" value="${(tenderDoc.bidOpenPlace)!""}" onblur="validData()" style="width: 84%">
            </li>
        </ul>
                ...
                <#if bidders?? && bidders?size gt 0>
                    <#list bidders as bidder>
                        <tr>
                            ...
                            <td>${(bidder.bidderOpenInfo.rate)!""}</td>
                            <td>
