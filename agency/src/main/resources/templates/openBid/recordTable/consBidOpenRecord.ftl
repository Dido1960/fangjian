...
<div class="cen-btn" onclick="window.top.outBidOpenRecord()" style="margin-right: auto; margin-left: auto">生成开标记录表</div>
<div class="cen-set">
    <h3>开标记录表</h3>
    <form action="">
        <ul class="shang">
            <li>
                ...
                <input type="text" id="name" class="layui-bg-gray" title="${(bidSection.bidSectionName)!""}"
                       value="${(bidSection.bidSectionName)!""}" readonly>
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" id="hum" class="layui-bg-gray" value="${(tenderProject.tenderProjectCode)!""}"
                       readonly>
            </li>
            <li>
                <label for="dian">浮动点</label>
                <input type="text" id="dian" class="layui-bg-gray" value="${(tenderDoc.floatPoint)!""}%" readonly>
            </li>
            <li>
                <label for="price">控制价</label>
                <input type="text" id="price" class="layui-bg-gray"
            ...
            <li style="width: 100%">
                ...
                <input type="text" id="bidOpenPlace" value="${(tenderDoc.bidOpenPlace)!""}" style="width: 84%"
                       onblur="validData()">
            </li>
        </ul>
        <table class="layui-table bid-open-table">
            ...
            <tr class="bei" style="height: 100px;">
                ...
                <textarea style="width: 100%; height: 100px; border: none;resize: none; white-space: pre-wrap" maxlength="200"
                          onblur="updateDesc(this)"><#if tenderDoc.openBidRecordDes??>${tenderDoc.openBidRecordDes}<#else>
                        <#if biddersFail??>
            ...
            <tr>
                ...
                <td colspan="5" style="border-left: #fff"></td>
            </tr>
            </tfoot>
        </table>
    </form>
