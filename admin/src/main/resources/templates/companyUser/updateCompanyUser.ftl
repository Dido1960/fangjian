    ...
    <script type="text/javascript">
        ...
        layui.use('form', function () {
            ...
            form.on('submit(*)', function (data) {
                layer.load();
                $.ajax({
                    url: '${ctx}/admin/companyUser/updateCompanyUser',
                    type: 'post',
                    cache: false,
                    async: false,
...
<form class="layui-form" method="post" id="form1">
    ...
    <div class="layui-form-item" style="margin-top: 20px">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="name" value="${companyUser.name}" id="name" lay-verify="required"
                   autocomplete="off"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="loginName" value="${companyUser.loginName}" id="login-name"
                   lay-verify="required|loginName" minlength="6" placeholder="请输入登录名"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="type" lay-verify="required" value="${companyUser.code}" name="code" autocomplete="off"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="linkMan" lay-verify="required" value="${companyUser.linkMan}" placeholder="请输入联系人"
                   autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="phone" id="phone" lay-verify="required" value="${companyUser.phone}"
                   autocomplete="off"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="address" lay-verify="required" value="${companyUser.address}" placeholder="请输入联系人"
                   autocomplete="off" class="layui-input">
        </div>
    </div>
