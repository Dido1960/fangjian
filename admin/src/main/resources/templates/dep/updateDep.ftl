...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend style="font-weight: bold">部门修改</legend>
</fieldset>
<form class="layui-form" method="post" id="dep-form">
    ...
    <div class="layui-form-item" style="margin-top: 20px">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="depName" id="dep-name" value="${dep.depName}" lay-verify="required"
    ...
    <div class="layui-form-item" style="margin-top: 20px">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <@WordBookTag key="govDepType" name="govDepType" id="govDepType" please="t" verify="required" value="${dep.govDepType}"></@WordBookTag>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label" style="width: auto;">统一信用代码</label>
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="code" id="code" value="${dep.code!}" onkeyup="value=value.replace(/[^\w\/]/ig,'')"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="regName" id="reg-name" value="${dep.regName}" lay-verify="required"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="phone" id="phone" value="${dep.phone!}" lay-verify="required|tell_phone"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="remark" id="remark" value="${dep.remark!}" lay-verify="required" autocomplete="off"
