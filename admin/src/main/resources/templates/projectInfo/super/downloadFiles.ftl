...
<div class="cont">
    ...
    <div class="project">
        <#include "${ctx}/projectInfo/super/downloadProjectFiles.ftl"/>
    </div>
    <div class="tender" style="display: none;">
        <#include "${ctx}/projectInfo/super/downloadBidFiles.ftl"/>
    </div>
</div>
</body>
<script>
    ...
    function showPdf(url) {
        window.top.layer.open({
            ...
            move: false,
            offset: 'auto',
            content: "${ctx}/projectInfo/previewPDFPage?url="+url,
            btn1: function (index) {
