...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend style="font-weight: bold">新增场地</legend>
</fieldset>
    ...
    <div class="layui-form-item" style="margin-top: 20px">
        ...
        <div class="layui-input-block" style="margin-left: 120px;width: 700px">
            <input type="text" name="name" id="site-name" lay-verify="required"
                   class="layui-input" placeholder="请输入场地名称">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">场地类型</label>
        <div class="layui-input-block" style="margin-left: 120px;width: 700px">
            <@WordBookTag key="siteType" name="type" id="siteType" please="t" verify="required"></@WordBookTag>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">备注</label>
        <div class="layui-input-block" style="margin-left: 120px;width: 700px">
            <input type="text" name="remark" id="remark" lay-verify="required" autocomplete="off" class="layui-input" placeholder="请输入备注">
        </div>
    </div>
