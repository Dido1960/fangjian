    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="loginName" id="login-name" value="${userInfo.loginName}" lay-verify="required"
                   placeholder="请输入登录名" autocomplete="off" class="layui-input" maxlength="50">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="roleName" id="role-name" onclick="chooseRole()"
                   value="${userInfo.roleName!}" class="layui-input" readonly>
...
<script type="text/javascript">
    ...
    function chooseRole() {
        ...
        choose_role_index = window.top.layer.open({
            ...
            area: ['45%', '60%'],
            btn: ['确认', '取消'],
            content: '${ctx}/govUser/chooseRolePage?roleId=' + roleId,
    ...
    function updateUser(successFunc) {
        ...
        if (user_name && login_name && reg_id) {
            $.ajax({
