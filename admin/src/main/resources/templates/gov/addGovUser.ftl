...
<form class="layui-form" method="post" id="form1">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="text" name="loginName" id="loginName" lay-verify="required|loginName" placeholder="请输入登录名"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block" style="margin-left: 120px">
            <input type="password" name="password2" id="password2" lay-verify="required|passwordConfirm"
                   autocomplete="off"
                   class="layui-input" maxlength="50">
        </div>
    </div>
    ...
    <div class="layui-hide">
        <input type="text" name="depId" value="${dep.id}" maxlength="50">
    </div>
