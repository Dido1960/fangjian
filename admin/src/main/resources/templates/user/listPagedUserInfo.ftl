...
<script type="text/html" id="barOperate">
    ...
    <a class="layui-btn layui-btn-sm" onclick="bindCa('{{d.id}}','0')">绑定CA</a>
    <a class="layui-btn layui-btn-sm" lay-event="resetPwd">密码重置</a>
</script>
...
<script type="text/javascript">
    ...
    layui.use(['form', 'table', 'layer'], function () {
        ...
        tableIns = table.render({
            height: 'full-60'
            , elem: '#list-user'
            , url: '${ctx}/user/pagedUser?regId=' + '${regId}'
    ...
    function addUserPage() {
        window.layer.open({
            ...
            area: ['100%', '100%'],
            btn: ['确认', '取消'],
            content: '${ctx}/user/addUserPage?regId=' + '${regId}',
            btn1: function (index, layero) {
                var body = window.layer.getChildFrame('body', index);
                var iframeWin = window[layero.find('iframe')[0]['name']];
