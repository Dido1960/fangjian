...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend style="font-weight: bold">新增印模签章配置</legend>
</fieldset>
...
<script type="text/javascript">
    ...
    layui.use(['form', 'layer'], function () {
        ...
        form.on('submit(*)', function (data) {
            ...
            lock = true;
            $.ajax({
                url: '${ctx}/signatureConfig/addSignatureConfigInfo',
                type: 'post',
                cache: false,
                async: false,
     ...
     */
    function addSignatureConfigInfo(successFunc1) {
