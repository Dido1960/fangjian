...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend style="font-weight: bold">印模签章配置查看</legend>
</fieldset>
    ...
    <div class="layui-form-item" style="margin-top: 20px">
        ...
        <div class="layui-input-block" style="margin-left: 120px;width: 600px">
            <input type="text" name="impressionNo" id="impression-no" lay-verify="required"
                   class="layui-input" placeholder="请输入印模编号" value="${signatureConfigInfo.impressionNo}" readonly>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">备注</label>
        <div class="layui-input-block" style="margin-left: 120px;width: 600px">
            <input type="text" name="remark" id="remark" lay-verify="required" autocomplete="off" class="layui-input" placeholder="请输入备注"  value="${signatureConfigInfo.remark}" readonly>
        </div>
    </div>
</form>
