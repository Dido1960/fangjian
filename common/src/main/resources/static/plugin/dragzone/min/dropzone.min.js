...
var _createClass = function () {
    ...
    function b(a, c) {
        ...
        var d = _possibleConstructorReturn(this, (b.__proto__ || Object.getPrototypeOf(b)).call(this)), e = void 0, f = void 0;
        ...
        key: "createThumbnailFromUrl", value: function (a, b, c, d, e, f, g) {
            ...
            return g && (i.crossOrigin = g), i.onload = function () {
                ...
                return "undefined" != typeof EXIF && null !== EXIF && e && (g = function (a) {
                    ...
                    var g = h.options.resize.call(h, a, b, c, d), j = document.createElement("canvas"), k = j.getContext("2d");
                ...
                if (a[0].upload.chunked) {
                    ...
                    var h = function () {
                        ...
                        if (!(d >= e.upload.totalChunkCount)) {
                            g++;
                            var h = d * c.options.chunkSize, i = Math.min(h + c.options.chunkSize, e.size),
...
var detectVerticalSquash = function (a) {
    ...
    return _createClass(a, null, [{
        ...
        key: "decode64", value: function (a) {
            var b = void 0, c = void 0, d = "", e = void 0, f = void 0, g = void 0, h = "", i = 0, j = [], k = /[^A-Za-z0-9\+\/\=]/g;
...
var contentLoaded = function (a, b) {
    var c = !1, d = !0, e = a.document, f = e.documentElement, g = e.addEventListener ? "addEventListener" : "attachEvent", h = e.addEventListener ? "removeEventListener" : "detachEvent",
