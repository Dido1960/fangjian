 ...
 */
@Component
public class ViewWordBookTag extends BaseTag {

    private static final String TAG_NAME = "ViewWordBookTag";

    public ViewWordBookTag() {
        super(TAG_NAME);
    }
     ...
     * 模板文件
     */
    private static final String TEMPLATE_NAME = "/tag/ViewWordBookTag.ftl";
    ...
    public void execute(Environment environment, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
        ...
        String value = TagUtil.getTemplateModel(PARAM_VALUE, params);
        Wordbook  wordbook = wordbookService.getWordBook(key,value);

        params.put("wordbook", wordbook);
