 ...
 */
@Configuration
@EnableRedisHttpSession(maxInactiveIntervalInSeconds = 3600,redisNamespace = "bid_con_supervise_session")
public class RedisSessionConfig {
    ...
    public DefaultCookieSerializer defaultCookieSerializer() {
        ...
        cookieSerializer.setCookieName("NORMAL_BID_CON_SUPERVISE_COOKIE");
